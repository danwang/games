...
import { type PlayerSummaryModel } from './game-ui.js';

const TrophyIcon = () => (
  <svg aria-hidden="true" className="h-4 w-4 text-amber-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                return (
                  <div
                    className={`flex items-center justify-between rounded-[1rem] border px-3 py-3 ${
                      isWinner ? 'border-amber-300/35 bg-amber-300/10' : 'border-white/8 bg-white/4'
                    }`}
